...
let data = { image: 'hey', name: "Borja Muñoz", email: "borjamunoz@europapress.es", user: "cchu01", language: "English (United States)", PrivacySettings: "Only administrators and other instructors can view my profile information" };
    ...
    let myRender = undefined
    {
      if (this.state.isEditable) {
        if (this.state.isText) {
          ...
          myRender = <div> <input type="text"></input> <button onClick={this.editField} >No Editar</button></div>
        }
      } else {
